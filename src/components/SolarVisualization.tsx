...
const SunObject = () => {
  ...
  const texture = useLoader(TextureLoader, sunTexture, 
    ...
    (error) => {
      ...
      setSunTexture(FALLBACK_SUN_TEXTURE);
    }
  );
